...
func (srv *Server) DockerInfo(job *engine.Job) engine.Status {
	...
	v.SetBool("IPv6Forwarding", !srv.runtime.SystemConfig().IPv6ForwardingDisabled)
...
func (srv *Server) ContainerCreate(job *engine.Job) engine.Status {
	...
	if !container.Config.NetworkDisabled && srv.runtime.SystemConfig().IPv6ForwardingDisabled {
